import { ArrowRight, Brain, Cpu, Database, Shield, Cloud, Zap, Code, BarChart, Users, Star, CheckCircle, GraduationCap, Heart, Building2, Factory, ShoppingCart } from 'lucide-react';
...
const Home = () => {
    ...
    return (
        <>
            ...
            {/* What We Do Section - Grid with Curved Cuts */}
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    ...
                    {/* Grid Layout with Curved Cut Cards */}
                    <div className="grid md:grid-cols-2 gap-8">
                        {[
                            ...
                            { 
                                ...
                                textColor: "text-orange-600",
                                borderColor: "border-orange-200",
                                cutDirection: "bottom-right"
                            }
                        ].map((item, index) => (
                            <div key={index} className="group relative overflow-hidden">
                                {/* Curved Cut Card */}
                                <div className={`relative p-8 bg-white border-2 ${item.borderColor} hover:shadow-2xl transition-all duration-500 group-hover:border-orange-400 group-hover:-translate-y-4 group-hover:scale-105 h-full
                                    ${item.cutDirection === 'top-right' ? 'rounded-tl-3xl rounded-bl-3xl rounded-br-3xl rounded-tr-lg' :
                                      item.cutDirection === 'top-left' ? 'rounded-tr-3xl rounded-br-3xl rounded-bl-3xl rounded-tl-lg' :
                                      item.cutDirection === 'bottom-right' ? 'rounded-tl-3xl rounded-tr-3xl rounded-bl-3xl rounded-br-lg' :
                                    ...
                                    <div className={`absolute inset-0 bg-gradient-to-br ${item.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500 
                                        ${item.cutDirection === 'top-right' ? 'rounded-tl-3xl rounded-bl-3xl rounded-br-3xl rounded-tr-lg' :
                                          item.cutDirection === 'top-left' ? 'rounded-tr-3xl rounded-br-3xl rounded-bl-3xl rounded-tl-lg' :
                                          item.cutDirection === 'bottom-right' ? 'rounded-tl-3xl rounded-tr-3xl rounded-bl-3xl rounded-br-lg' :
                                          'rounded-tr-3xl rounded-tl-3xl rounded-br-3xl rounded-bl-lg'}`}></div>
                                    
                                    {/* Decorative cut corner */}
                                    <div className={`absolute w-16 h-16 ${item.bgColor} opacity-20 
                                        ${item.cutDirection === 'top-right' ? 'top-0 right-0 rounded-bl-full' :
                                          item.cutDirection === 'top-left' ? 'top-0 left-0 rounded-br-full' :
                                          item.cutDirection === 'bottom-right' ? 'bottom-0 right-0 rounded-tl-full' :
                                          'bottom-0 left-0 rounded-tr-full'}`}></div>
                                    
                                    {/* Icon with animated background */}
                                    <div className={`w-24 h-24 ${item.bgColor} rounded-2xl flex items-center justify-center ${item.textColor} mb-6 group-hover:scale-110 transition-all duration-300 relative overflow-hidden z-10`}>
                                        <div className={`absolute inset-0 bg-gradient-to-br ${item.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300 rounded-2xl`}></div>
                                        <div className="relative z-10">
                                            {item.icon}
                                        </div>
                                    </div>
                                    
                                    <h3 className="text-2xl font-bold mb-4 group-hover:text-gray-900 transition-colors relative z-10">{item.title}</h3>
                                    <p className="text-gray-600 mb-6 leading-relaxed relative z-10">{item.desc}</p>
                                    ...
                                    <ul className="space-y-3 mb-8 relative z-10">
                                        {item.features.map((feature, idx) => (
                                            <li key={idx} className="flex items-center gap-3 text-sm text-gray-600 group-hover:text-gray-700 transition-colors">
                                                <div className={`w-2 h-2 rounded-full ${item.textColor.replace('text-', 'bg-')} group-hover:scale-125 transition-transform duration-300`}></div>
                                    ...
                                    {/* CTA Button */}
                                    <Link to="/services" className={`inline-flex items-center gap-2 ${item.textColor} font-semibold group-hover:gap-4 transition-all duration-300 hover:underline relative z-10`}>
                                        Learn More 
            ...
            {/* Industries We Serve - Enhanced with Modern Design */}
            <section className="py-24 bg-gradient-to-br from-slate-50 to-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-block px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full font-semibold text-sm mb-6 shadow-lg">
                            🌍 DIVERSE EXPERTISE
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Industries We Serve</h2>
                    ...
                    {/* Enhanced Industries Grid with Hexagonal Cards */}
                    <div className="grid md:grid-cols-2 gap-8 mb-16">
                        {[
                            ...
                            const colorClasses = {
                                blue: { bg: "bg-orange-50", text: "text-orange-500", border: "border-orange-200", gradient: "from-orange-400 to-orange-600", shadow: "shadow-orange-200" },
                                red: { bg: "bg-orange-50", text: "text-orange-500", border: "border-orange-200", gradient: "from-orange-500 to-red-600", shadow: "shadow-orange-200" },
                                green: { bg: "bg-orange-50", text: "text-orange-500", border: "border-orange-200", gradient: "from-amber-500 to-orange-600", shadow: "shadow-orange-200" },
                                orange: { bg: "bg-orange-50", text: "text-orange-500", border: "border-orange-200", gradient: "from-orange-500 to-orange-600", shadow: "shadow-orange-200" },
                                purple: { bg: "bg-orange-50", text: "text-orange-500", border: "border-orange-200", gradient: "from-orange-600 to-amber-600", shadow: "shadow-orange-200" },
                                indigo: { bg: "bg-orange-50", text: "text-orange-500", border: "border-orange-200", gradient: "from-orange-400 to-orange-700", shadow: "shadow-orange-200" }
                            };
                            
                            return (
                                <div 
                                    key={index} 
                                    className="group relative overflow-hidden transform hover:scale-110 transition-all duration-500 hover:rotate-1"
                                    style={{ animationDelay: `${index * 150}ms` }}
                                >
                                    {/* Background Pattern */}
                                    <div className="absolute top-4 right-4 text-6xl opacity-10 group-hover:opacity-30 group-hover:scale-125 transition-all duration-500">
                                        {industry.bgPattern}
                                    </div>
                                    
                                    {/* Hover gradient overlay */}
                                    <div className={`absolute inset-0 bg-gradient-to-br ${colorClasses[industry.color].gradient} opacity-0 group-hover:opacity-15 transition-opacity duration-500 rounded-3xl`}></div>
                                    
                                    {/* Main card with modern design */}
                                    <div className={`relative p-8 border-2 ${colorClasses[industry.color].border} rounded-3xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 group-hover:border-orange-400 group-hover:-translate-y-6 h-full ${colorClasses[industry.color].shadow}`}>
                                        {/* Icon with enhanced design */}
                                        <div className={`w-20 h-20 ${colorClasses[industry.color].bg} rounded-2xl flex items-center justify-center ${colorClasses[industry.color].text} mb-6 group-hover:scale-110 transition-all duration-300 relative overflow-hidden shadow-lg`}>
                                            <div className={`absolute inset-0 bg-gradient-to-br ${colorClasses[industry.color].gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}></div>
                                            <div className="relative z-10">
                                                {industry.icon}
                                            </div>
                                        </div>
                                        ...
                                        {/* Content */}
                                        <h3 className="text-2xl font-bold mb-3 group-hover:text-gray-900 transition-colors">{industry.name}</h3>
                                        <p className="text-gray-600 mb-4 leading-relaxed text-sm">{industry.desc}</p>
                                        
                                        {/* Stats with enhanced design */}
                                        <div className={`inline-flex items-center px-4 py-2 ${colorClasses[industry.color].bg} ${colorClasses[industry.color].text} rounded-full text-sm font-semibold mb-6 shadow-sm`}>
                                            <div className="w-2 h-2 bg-current rounded-full mr-2 animate-pulse"></div>
                                            {industry.stats}
                                        </div>
                                        
                                        {/* Features with enhanced bullets */}
                                        <ul className="space-y-2 mb-6">
                                            {industry.features.map((feature, idx) => (
                                                <li key={idx} className="flex items-center gap-3 text-sm text-gray-600 group-hover:text-gray-700 transition-colors">
                                                    <div className={`w-1.5 h-1.5 rounded-full ${colorClasses[industry.color].text.replace('text-', 'bg-')} group-hover:scale-150 transition-transform duration-300`}></div>
                                                    <span className="font-medium">{feature}</span>
                                                </li>
                                            ))}
                                        </ul>
                                        ...
                                        {/* Enhanced CTA */}
                                        <Link to="/industries" className={`inline-flex items-center gap-2 ${colorClasses[industry.color].text} font-semibold group-hover:gap-4 transition-all duration-300 hover:underline text-sm`}>
                                            Explore Solutions
                    ...
                    <div className="text-center">
                        <Link to="/industries" className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-full font-semibold hover:from-orange-600 hover:to-red-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                        ...
                        <div className="scroll-fade-left scroll-fade-right">
                            <div className="flex animate-scroll-reverse">
                                ...
                                {[
                                    ...
                                    <div key={index} className="flex-shrink-0 mx-6 w-96">
                                        <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 group border border-gray-100 hover:-translate-y-2 h-full">
                                            <div className="flex items-center gap-3 mb-6">
                                                <div className="text-3xl">{study.icon}</div>
                                                <div>
                                                    <div className={`w-3 h-3 rounded-full ${study.color === 'blue' ? 'bg-blue-500' : 
                                                        study.color === 'green' ? 'bg-green-500' : 
                                                        study.color === 'orange' ? 'bg-orange-500' :
                                                        study.color === 'purple' ? 'bg-purple-500' :
                                                        study.color === 'red' ? 'bg-red-500' : 'bg-indigo-500'} mb-2`}></div>
                                                    <span className="text-sm text-gray-500 uppercase tracking-wider">{study.industry}</span>
                                                </div>
                                            </div>
                                            
                                            <h3 className="text-xl font-bold mb-3 group-hover:text-gray-900 transition-colors">{study.title}</h3>
                                            <p className="text-gray-600 mb-4 leading-relaxed">{study.result}</p>
                                            <p className="text-sm text-gray-500 mb-6 italic">{study.details}</p>
                                            
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <div className={`text-4xl font-bold ${study.color === 'blue' ? 'text-blue-500' : 
                                                        study.color === 'green' ? 'text-green-500' : 
                                                        study.color === 'orange' ? 'text-orange-500' :
                                                        study.color === 'purple' ? 'text-purple-500' :
                                                        study.color === 'red' ? 'text-red-500' : 'text-indigo-500'} group-hover:scale-110 transition-transform duration-300`}>
                                                        {study.metric}
                                                    </div>
                                    ...
                                    [
                                        ...
                                        <div key={`duplicate-${index}`} className="flex-shrink-0 mx-6 w-96">
                                            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 group border border-gray-100 hover:-translate-y-2 h-full">
                                                <div className="flex items-center gap-3 mb-6">
                                                    <div className="text-3xl">{study.icon}</div>
                                                    <div>
                        ...
                        {[
                            ...
                            return (
                                <div key={index} className="text-center p-6 rounded-2xl hover:shadow-lg transition-all duration-300">
                                    <div className={`w-16 h-16 ${colorClasses[value.color]} rounded-full flex items-center justify-center mx-auto mb-6`}>
                                        {value.icon}
                                    </div>
                            ...
                            <div className="flex animate-scroll">
                                ...
                                {clients.map((client, index) => (
                                    <div key={index} className="flex-shrink-0 mx-12">
                                        <div className="w-32 h-20 bg-white border border-gray-200 rounded-xl flex items-center justify-center hover:border-orange-300 hover:shadow-md transition-all duration-300 cursor-pointer group">
                                            <div className="text-center">
                                                <div className="text-2xl font-bold text-gray-400 group-hover:text-orange-500 transition-colors">
                                                    {client.logo}
                                                </div>
