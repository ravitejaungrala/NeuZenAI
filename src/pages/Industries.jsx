import { GraduationCap, Heart, Building2, Factory, ShoppingCart, Shield, ArrowRight, TrendingUp } from 'lucide-react';
    ...
    const industries = [
        {
            ...
            title: "Education",
            description: "Revolutionizing learning with personalized AI tutors, automated grading, and predictive analytics for student success.",
            features: ["Personalized Learning", "Automated Assessment", "Student Analytics", "Virtual Assistants"],
            stats: { metric: "95%", label: "Student Engagement" },
            color: "blue"
        },
        {
            icon: <Heart className="w-8 h-8" />,
            title: "Healthcare",
            description: "Enhancing patient care through diagnostic AI, treatment optimization, and predictive health monitoring.",
            features: ["Medical Imaging AI", "Drug Discovery", "Patient Monitoring", "Clinical Decision Support"],
            stats: { metric: "40%", label: "Faster Diagnosis" },
            color: "red"
        },
        {
            icon: <Building2 className="w-8 h-8" />,
            title: "Finance",
            description: "Transforming financial services with fraud detection, algorithmic trading, and risk assessment solutions.",
            features: ["Fraud Detection", "Risk Assessment", "Algorithmic Trading", "Credit Scoring"],
            stats: { metric: "99.8%", label: "Fraud Detection Rate" },
            color: "green"
        },
        {
            icon: <Factory className="w-8 h-8" />,
            title: "Manufacturing",
            description: "Optimizing production with predictive maintenance, quality control, and supply chain intelligence.",
            features: ["Predictive Maintenance", "Quality Control", "Supply Chain Optimization", "Process Automation"],
            stats: { metric: "30%", label: "Cost Reduction" },
            color: "orange"
        },
        {
            icon: <ShoppingCart className="w-8 h-8" />,
            title: "Retail",
            description: "Enhancing customer experience with recommendation engines, inventory optimization, and demand forecasting.",
            features: ["Recommendation Systems", "Inventory Management", "Price Optimization", "Customer Analytics"],
            stats: { metric: "25%", label: "Sales Increase" },
            color: "purple"
        },
        {
            icon: <Shield className="w-8 h-8" />,
            title: "Government",
            description: "Improving public services with citizen engagement platforms, resource optimization, and security solutions.",
            features: ["Citizen Services", "Resource Planning", "Security Analytics", "Policy Optimization"],
